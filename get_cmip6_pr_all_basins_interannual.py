...
path = '/nfs/a68/gyjcab/datasets/cmip6/pr/historical/ensemble_means/'
startyr = 2003
endyr = 2013
...
models = ['ACCESS-CM2', 'ACCESS-ESM1-5', 'BCC-CSM2-MR', 'BCC-ESM1',
          'CAMS-CSM1-0', 'CanESM5', 'CESM2-FV2', 'CESM2',
          'CESM2-WACCM-FV2', 'CESM2-WACCM', 'FGOALS-g3', 'GISS-E2-1-G-CC',
          'GISS-E2-1-G', 'GISS-E2-1-H', 'HadGEM3-GC31-LL', 'HadGEM3-GC31-MM',
          'MCM-UA-1-0', 'MIROC6', 'MPI-ESM-1-2-HAM', 'MPI-ESM1-2-HR',
...
results_dict = {}
#basin_shapes = ['solimoes_dissolved5']
...
np.save(outpath + 'cmip6_all_basins_pr_'+ str(startyr) + '_' +
